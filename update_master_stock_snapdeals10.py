...
def main():
    ...
    # master files
    master_filename = 'master_refresh_update10_' + str(int(datetime.timestamp(datetime.now()))) + '.csv'
    ...
    # snapdeal files
    snapdeal_filename = 'master_refresh_snapdeal_update10_' + str(
    ...
    #products_query = "SELECT product_id, buymore_sku from master_masterproduct where product_id = 250902 and buymore_sku = 'Nyle_NY0800CNS02R'"
    ...
    for item  in binreco:
        ...
        #     warehouse_id)
        query = "SELECT * from api_masterstock where product_id = " + str(product_id) + " and warehouse= 4"
