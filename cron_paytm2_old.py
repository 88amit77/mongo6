...
def main():
    ...
    # products_query = "SELECT product_id, buymore_sku from master_masterproduct where product_id in ('234221','196675')"
    products_query = "SELECT product_id, buymore_sku from master_masterproduct limit 100"
